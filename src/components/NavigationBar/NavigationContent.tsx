        ...
        <div className='xl:px-20 mx-auto'>
            <div className="flex items-center justify-between leading-none">
                        ...
                        {navigation.data?.links.map((item: any) => {
                            ...
                            return (
                                <li
                                    ...
                                    className={`font-semibold xl:text-xl tracking-tight hover:text-brand duration-200 ${isActive ? 'text-brand' : 'text-slate-800'
                                        }`}
                                >
                ...
                <div className='hidden md:block'>
                    <Button className="bg-brand text-white hover:bg-brand/90 cursor-pointer px-8 py-6">Contact Us</Button>
                </div>
